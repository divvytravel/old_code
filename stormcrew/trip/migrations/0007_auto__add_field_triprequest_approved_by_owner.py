...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TripRequest.approved_by_owner'
        db.add_column(u'trip_triprequest', 'approved_by_owner',
    ...
    def backwards(self, orm):
        # Deleting field 'TripRequest.approved_by_owner'
        db.delete_column(u'trip_triprequest', 'approved_by_owner')
