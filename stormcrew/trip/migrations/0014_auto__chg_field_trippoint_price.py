...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TripPoint.price'
        db.alter_column(u'trip_trippoint', 'price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TripPoint.price'
        db.alter_column(u'trip_trippoint', 'price', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        u'trip.trippointtype': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trip.TripCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
