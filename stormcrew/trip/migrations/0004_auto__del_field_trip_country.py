...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'trip_trip', 'country')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trip.country'
        raise RuntimeError("Cannot reverse this migration. 'Trip.country' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Trip.country'
