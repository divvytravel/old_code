...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TripCategory.applicable'
        db.add_column(u'trip_tripcategory', 'applicable',
                      self.gf('django.db.models.fields.CharField')(default='all', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TripCategory.applicable'
        db.delete_column(u'trip_tripcategory', 'applicable')
