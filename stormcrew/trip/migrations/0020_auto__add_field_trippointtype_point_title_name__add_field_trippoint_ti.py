...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TripPointType.point_title_name'
        db.add_column(u'trip_trippointtype', 'point_title_name',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=100),
                      keep_default=False)

        # Adding field 'TripPoint.title'
        db.add_column(u'trip_trippoint', 'title',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TripPointType.point_title_name'
        db.delete_column(u'trip_trippointtype', 'point_title_name')

        # Deleting field 'TripPoint.title'
        db.delete_column(u'trip_trippoint', 'title')
