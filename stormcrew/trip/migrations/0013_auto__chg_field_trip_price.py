...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.price'
        db.alter_column(u'trip_trip', 'price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Trip.price'
        db.alter_column(u'trip_trip', 'price', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
