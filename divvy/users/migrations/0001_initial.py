...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_user', (
            ...
            ('avatar_url', self.gf('django.db.models.fields.CharField')(default='/static/img/no-avatar.jpg', max_length=200)),
            ('provider', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
