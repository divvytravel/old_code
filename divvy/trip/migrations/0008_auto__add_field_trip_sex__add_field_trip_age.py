...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.sex'
        db.add_column(u'trip_trip', 'sex',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.age'
        db.add_column(u'trip_trip', 'age',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.sex'
        db.delete_column(u'trip_trip', 'sex')

        # Deleting field 'Trip.age'
        db.delete_column(u'trip_trip', 'age')
