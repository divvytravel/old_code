...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trip.descr_share'
        db.delete_column(u'trip_trip', 'descr_share')

        # Deleting field 'Trip.includes'
        db.delete_column(u'trip_trip', 'includes')


    def backwards(self, orm):
        # Adding field 'Trip.descr_share'
        db.add_column(u'trip_trip', 'descr_share',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Trip.includes'
        raise RuntimeError("Cannot reverse this migration. 'Trip.includes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Trip.includes'
        db.add_column(u'trip_trip', 'includes',
    ...
    models = {
        ...
        u'trip.trip': {
            ...
            '_descr_main_rendered': ('django.db.models.fields.TextField', [], {}),
            ...
            'descr_include': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'descr_main': ('markupfield.fields.MarkupField', [], {'rendered_field': 'True'}),
            'descr_main_markup_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '30'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            'end_people_date': ('django.db.models.fields.DateField', [], {}),
            'general_price': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'trip.triprequest': {
            'Meta': {'ordering': "('-date_created',)", 'unique_together': "(('trip', 'user'),)", 'object_name': 'TripRequest'},
            'allow_post_fb': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
