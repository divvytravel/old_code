...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TripRequest.allow_post_fb'
        db.add_column(u'trip_triprequest', 'allow_post_fb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TripRequest.allow_post_fb'
        db.delete_column(u'trip_triprequest', 'allow_post_fb')
