...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TripPoint.p_type'
        db.alter_column(u'trip_trippoint', 'p_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trip.TripPointType'], null=True))

    def backwards(self, orm):

        # Changing field 'TripPoint.p_type'
        db.alter_column(u'trip_trippoint', 'p_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['trip.TripPointType']))
