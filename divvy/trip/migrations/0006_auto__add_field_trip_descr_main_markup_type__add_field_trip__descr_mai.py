...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.descr_main_markup_type'
        db.add_column(u'trip_trip', 'descr_main_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30),
                      keep_default=False)

        # Adding field 'Trip._descr_main_rendered'
        db.add_column(u'trip_trip', '_descr_main_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Trip.descr_main'
        db.alter_column(u'trip_trip', 'descr_main', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'Trip.descr_main_markup_type'
        db.delete_column(u'trip_trip', 'descr_main_markup_type')

        # Deleting field 'Trip._descr_main_rendered'
        db.delete_column(u'trip_trip', '_descr_main_rendered')


        # Changing field 'Trip.descr_main'
        db.alter_column(u'trip_trip', 'descr_main', self.gf('django.db.models.fields.TextField')())
