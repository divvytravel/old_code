...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TripRequest', fields ['trip', 'user']
        db.create_unique(u'trip_triprequest', ['trip_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TripRequest', fields ['trip', 'user']
        db.delete_unique(u'trip_triprequest', ['trip_id', 'user_id'])
