...
define([
    ...
    'apps/tripsFilter/collections/countries',
    'apps/tripsFilter/collections/dates',
    'apps/tripsFilter/collections/filterPeopleCount',
    'apps/tripsFilter/views/filterPeopleCountView',
    'apps/tripsFilter/views/filterTagsView',
    'jquery',
    'hb',
    'jquery-ui',
